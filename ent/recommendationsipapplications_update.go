...
func (riau *RecommendationsIPApplicationsUpdate) SetCAUpdatedAt(s string) *RecommendationsIPApplicationsUpdate {
	riau.mutation.SetCAUpdatedAt(s)
	return riau
}

// SetNillableCAUpdatedAt sets the "CA_UpdatedAt" field if the given value is not nil.
func (riau *RecommendationsIPApplicationsUpdate) SetNillableCAUpdatedAt(s *string) *RecommendationsIPApplicationsUpdate {
	if s != nil {
		riau.SetCAUpdatedAt(*s)
	}
	return riau
}
...
func (riau *RecommendationsIPApplicationsUpdate) SetNOUpdatedAt(s string) *RecommendationsIPApplicationsUpdate {
	riau.mutation.SetNOUpdatedAt(s)
	return riau
}

// SetNillableNOUpdatedAt sets the "NO_UpdatedAt" field if the given value is not nil.
func (riau *RecommendationsIPApplicationsUpdate) SetNillableNOUpdatedAt(s *string) *RecommendationsIPApplicationsUpdate {
	if s != nil {
		riau.SetNOUpdatedAt(*s)
	}
	return riau
}
...
func (riau *RecommendationsIPApplicationsUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := riau.mutation.CAUpdatedAt(); ok {
		_spec.SetField(recommendationsipapplications.FieldCAUpdatedAt, field.TypeString, value)
	}
	if riau.mutation.CAUpdatedAtCleared() {
		_spec.ClearField(recommendationsipapplications.FieldCAUpdatedAt, field.TypeString)
	}
	...
	if value, ok := riau.mutation.NOUpdatedAt(); ok {
		_spec.SetField(recommendationsipapplications.FieldNOUpdatedAt, field.TypeString, value)
	}
	if riau.mutation.NOUpdatedAtCleared() {
		_spec.ClearField(recommendationsipapplications.FieldNOUpdatedAt, field.TypeString)
	}
...
// SetCAUpdatedAt sets the "CA_UpdatedAt" field.
func (riauo *RecommendationsIPApplicationsUpdateOne) SetCAUpdatedAt(s string) *RecommendationsIPApplicationsUpdateOne {
	riauo.mutation.SetCAUpdatedAt(s)
	return riauo
}

// SetNillableCAUpdatedAt sets the "CA_UpdatedAt" field if the given value is not nil.
func (riauo *RecommendationsIPApplicationsUpdateOne) SetNillableCAUpdatedAt(s *string) *RecommendationsIPApplicationsUpdateOne {
	if s != nil {
		riauo.SetCAUpdatedAt(*s)
	}
	return riauo
}
...
// SetNOUpdatedAt sets the "NO_UpdatedAt" field.
func (riauo *RecommendationsIPApplicationsUpdateOne) SetNOUpdatedAt(s string) *RecommendationsIPApplicationsUpdateOne {
	riauo.mutation.SetNOUpdatedAt(s)
	return riauo
}

// SetNillableNOUpdatedAt sets the "NO_UpdatedAt" field if the given value is not nil.
func (riauo *RecommendationsIPApplicationsUpdateOne) SetNillableNOUpdatedAt(s *string) *RecommendationsIPApplicationsUpdateOne {
	if s != nil {
		riauo.SetNOUpdatedAt(*s)
	}
	return riauo
}
