...
func (riac *RecommendationsIPApplicationsCreate) SetCAUpdatedAt(s string) *RecommendationsIPApplicationsCreate {
	riac.mutation.SetCAUpdatedAt(s)
	return riac
}

// SetNillableCAUpdatedAt sets the "CA_UpdatedAt" field if the given value is not nil.
func (riac *RecommendationsIPApplicationsCreate) SetNillableCAUpdatedAt(s *string) *RecommendationsIPApplicationsCreate {
	if s != nil {
		riac.SetCAUpdatedAt(*s)
	}
	return riac
}
...
func (riac *RecommendationsIPApplicationsCreate) SetNOUpdatedAt(s string) *RecommendationsIPApplicationsCreate {
	riac.mutation.SetNOUpdatedAt(s)
	return riac
}

// SetNillableNOUpdatedAt sets the "NO_UpdatedAt" field if the given value is not nil.
func (riac *RecommendationsIPApplicationsCreate) SetNillableNOUpdatedAt(s *string) *RecommendationsIPApplicationsCreate {
	if s != nil {
		riac.SetNOUpdatedAt(*s)
	}
	return riac
}
