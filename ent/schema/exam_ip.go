...
/// Fields of the Exam.
func (Exam_IP) Fields() []ent.Field {
	return []ent.Field{field.Int32("id").StorageKey("ExamCodeIP"), 
...
// Edges of the Exam.
func (Exam_IP) Edges() []ent.Edge {
	return []ent.Edge{	
	
	//edge.To("exam", Exam.Type).Ref("papers").Unique().Field("ExamCode"),
	edge.To("examcal_ip_ref", ExamCalendar.Type),
	edge.To("papers_ip_ref", ExamPapers.Type),
	edge.To("users_ip_type", UserMaster.Type),
	edge.To("ExamAppln_IP_Ref" , Exam_Applications_IP.Type),
	edge.To("notifications_ip", Notification.Type),

	}

}
func (Exam_IP) Annotations() []schema.Annotation {
	return []schema.Annotation{entsql.Annotation{Table: "Exam_IP"}}
}
