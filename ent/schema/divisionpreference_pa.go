...
/// Fields of the Exam.
func (Division_Choice_PA) Fields() []ent.Field {
...
// Edges of the Exam.
func (Division_Choice_PA) Edges() []ent.Edge {
	return nil
	//[]ent.Edge{		
...
func (Division_Choice_PA) Annotations() []schema.Annotation {
	return []schema.Annotation{entsql.Annotation{Table: "Division_Choice_PA"}}
}
