...
/// Fields of the Exam.
func (Exam_PS) Fields() []ent.Field {
	return []ent.Field{field.Int32("id").StorageKey("ExamCodePS"), 
...
func (Exam_PS) Annotations() []schema.Annotation {
	return []schema.Annotation{entsql.Annotation{Table: "Exam_PS"}}
}
