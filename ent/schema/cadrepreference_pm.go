...
/// Fields of the Exam.
func (Cadre_Choice_PM) Fields() []ent.Field {
...
// Edges of the Exam.
func (Cadre_Choice_PM) Edges() []ent.Edge {
	return nil
	//[]ent.Edge{		
...
func (Cadre_Choice_PM) Annotations() []schema.Annotation {
	return []schema.Annotation{entsql.Annotation{Table: "Cadre_Choice_PM"}}
}
