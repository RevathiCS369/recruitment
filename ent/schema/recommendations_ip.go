...
func (RecommendationsIPApplications) Fields() []ent.Field {
	return []ent.Field{
...
func (RecommendationsIPApplications) Edges() []ent.Edge {
	return []ent.Edge{
		edge.From("ApplnRef", Exam_Applications_IP.Type).Ref("IPApplicationsRef").Unique().Field("ApplicationID"),
		}

}


func (RecommendationsIPApplications) Annotations() []schema.Annotation {
	return []schema.Annotation{entsql.Annotation{Table: "RecommendationsIPApplications"}}
}
