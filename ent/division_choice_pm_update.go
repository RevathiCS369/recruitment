...
func (dcpu *DivisionChoicePMUpdate) SetApplication(s string) *DivisionChoicePMUpdate {
	dcpu.mutation.SetApplication(s)
	return dcpu
}

// SetNillableApplication sets the "Application" field if the given value is not nil.
func (dcpu *DivisionChoicePMUpdate) SetNillableApplication(s *string) *DivisionChoicePMUpdate {
	if s != nil {
...
func (dcpu *DivisionChoicePMUpdate) ClearApplication() *DivisionChoicePMUpdate {
	dcpu.mutation.ClearApplication()
	return dcpu
}

// SetCadrePrefNo sets the "CadrePrefNo" field.
func (dcpu *DivisionChoicePMUpdate) SetCadrePrefNo(s string) *DivisionChoicePMUpdate {
	dcpu.mutation.SetCadrePrefNo(s)
	return dcpu
}

// SetCadrePrefValue sets the "CadrePrefValue" field.
func (dcpu *DivisionChoicePMUpdate) SetCadrePrefValue(s string) *DivisionChoicePMUpdate {
...
func (dcpu *DivisionChoicePMUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if dcpu.mutation.ApplicationCleared() {
		_spec.ClearField(division_choice_pm.FieldApplication, field.TypeString)
	}
...
// SetApplication sets the "Application" field.
func (dcpuo *DivisionChoicePMUpdateOne) SetApplication(s string) *DivisionChoicePMUpdateOne {
	dcpuo.mutation.SetApplication(s)
	return dcpuo
}

// SetNillableApplication sets the "Application" field if the given value is not nil.
func (dcpuo *DivisionChoicePMUpdateOne) SetNillableApplication(s *string) *DivisionChoicePMUpdateOne {
	if s != nil {
...
// ClearApplication clears the value of the "Application" field.
func (dcpuo *DivisionChoicePMUpdateOne) ClearApplication() *DivisionChoicePMUpdateOne {
	dcpuo.mutation.ClearApplication()
	return dcpuo
}

// SetCadrePrefNo sets the "CadrePrefNo" field.
func (dcpuo *DivisionChoicePMUpdateOne) SetCadrePrefNo(s string) *DivisionChoicePMUpdateOne {
	dcpuo.mutation.SetCadrePrefNo(s)
	return dcpuo
}

// SetCadrePrefValue sets the "CadrePrefValue" field.
func (dcpuo *DivisionChoicePMUpdateOne) SetCadrePrefValue(s string) *DivisionChoicePMUpdateOne {
