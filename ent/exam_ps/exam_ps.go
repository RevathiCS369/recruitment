...
const (
	// Label holds the string label denoting the exam_ps type in the database.
	Label = "exam_ps"
	...
	// Table holds the table name of the exam_ps in the database.
	Table = "Exam_PS"
	...
	ExamcalPsRefColumn = "exam_ps_examcal_ps_ref"
	...
	PapersPsRefColumn = "exam_ps_papers_ps_ref"
	...
	UsersPsTypeColumn = "exam_ps_users_ps_type"
	...
	ExamApplnPSRefColumn = "exam_ps_exam_appln_ps_ref"
	...
	NotificationsPsColumn = "exam_ps_notifications_ps"
)

// Columns holds all SQL columns for exam_ps fields.
var Columns = []string{
	FieldID,
	FieldExamNameCode,
	FieldExamName,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "Exam_PS"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"exam_calendar_examcal_ps_ref",
	"exam_papers_papers_ps_ref",
	"exam_applications_ps_exam_appln_ps_ref",
	"notification_notifications_ps",
	"user_master_users_ps_type",
}
...
// OrderOption defines the ordering options for the Exam_PS queries.
