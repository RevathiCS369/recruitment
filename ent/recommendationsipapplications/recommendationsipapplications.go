...
const (
	// Label holds the string label denoting the recommendationsipapplications type in the database.
	Label = "recommendations_ip_applications"
	...
	// Table holds the table name of the recommendationsipapplications in the database.
	Table = "RecommendationsIPApplications"
	// ApplnRefTable is the table that holds the ApplnRef relation/edge.
	ApplnRefTable = "RecommendationsIPApplications"
	// ApplnRefInverseTable is the table name for the Exam_Applications_IP entity.
	// It exists in this package in order to avoid circular dependency with the "exam_applications_ip" package.
	ApplnRefInverseTable = "Exam_Applications_IP"
	// ApplnRefColumn is the table column denoting the ApplnRef relation/edge.
	ApplnRefColumn = "application_id"
)

// Columns holds all SQL columns for recommendationsipapplications fields.
var Columns = []string{
	FieldID,
	FieldApplicationID,
	FieldEmployeeID,
...
// OrderOption defines the ordering options for the RecommendationsIPApplications queries.
...
func newApplnRefStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		...
		sqlgraph.To(ApplnRefInverseTable, Exam_Applications_IPFieldID),
