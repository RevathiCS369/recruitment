...
const (
	// Label holds the string label denoting the exam_pm type in the database.
	Label = "exam_pm"
	...
	// Table holds the table name of the exam_pm in the database.
	Table = "Exam_PM"
)

// Columns holds all SQL columns for exam_pm fields.
var Columns = []string{
	FieldID,
	FieldExamNameCode,
	FieldExamName,
...
// OrderOption defines the ordering options for the Exam_PM queries.
