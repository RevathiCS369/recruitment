...
const (
	// Label holds the string label denoting the division_choice_ps type in the database.
	Label = "division_choice_ps"
	...
	// Table holds the table name of the division_choice_ps in the database.
	Table = "Division_Choice_PS"
)

// Columns holds all SQL columns for division_choice_ps fields.
var Columns = []string{
	FieldID,
	FieldApplication,
	FieldCadrePrefNo,
...
// OrderOption defines the ordering options for the Division_Choice_PS queries.
