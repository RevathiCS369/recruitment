...
const (
	// Label holds the string label denoting the cadre_choice_pa type in the database.
	Label = "cadre_choice_pa"
	...
	// Table holds the table name of the cadre_choice_pa in the database.
	Table = "Cadre_Choice_PA"
)

// Columns holds all SQL columns for cadre_choice_pa fields.
var Columns = []string{
	FieldID,
	FieldApplication,
	FieldCadrePrefNo,
...
// OrderOption defines the ordering options for the Cadre_Choice_PA queries.
