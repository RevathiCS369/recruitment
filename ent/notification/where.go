...
func HasCenters() predicate.Notification {
	return predicate.Notification(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasCentersWith(preds ...predicate.Center) predicate.Notification {
	return predicate.Notification(func(s *sql.Selector) {
		step := newCentersStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasNodalOfficers() predicate.Notification {
	return predicate.Notification(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasNodalOfficersWith(preds ...predicate.NodalOfficer) predicate.Notification {
	return predicate.Notification(func(s *sql.Selector) {
